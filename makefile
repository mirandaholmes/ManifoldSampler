...
CPP_HEADERS = Framework.hpp ManifoldSampler.hpp
...
ManifoldSampler.o:  ManifoldSampler.cpp ManifoldSampler.hpp Framework.hpp 
	$(CC) -c $(OPTFLAGS) ManifoldSampler.cpp

Framework.o:  Framework.cpp Framework.hpp 
